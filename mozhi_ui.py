...
class UI:
    ...
    def banner(self, title: str = "Mozhi Compiler", subtitle: str = "Version 1.0",
    ...
    def diagnostic(self,
        ...
        """Render a diagnostic message in the Mozhi style.
    ...
    def repl_banner(self, version: str = "1.0"):
        ...
        self.write(self.c("Mozhi REPL", Colors.ACCENT))
